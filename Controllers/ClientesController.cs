...
namespace Formulario_Cadastro_Pessoa.Controllers
{
    public class ClientesController : Controller
    {
        private readonly Formulario_Cadastro_PessoaContext _context;

        public ClientesController(Formulario_Cadastro_PessoaContext context)
        {
            _context = context;
        }
